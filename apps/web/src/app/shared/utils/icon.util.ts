...
export function getContextIcon(
   ...
   */
export function getRoleIcon(role: 'mentee' | 'mentor' | 'admin'): IconName {
   ...
   */
export function getNavigationIcon(navItem: string): IconName {
...
export function getFieldIcon(
  fieldType: 'email' | 'password' | 'phone' | 'location' | 'calendar'
): IconName {
...
export function getStatusIcon(
   ...
   */
export function getSizeClasses(size: 'xs' | 'sm' | 'md' | 'lg' | 'xl'): string {
