...
export function getAlertClasses(type: AlertType): string {
...
export function getIconClasses(type: AlertType): string {
  switch (type) {
    case 'success':
...
export function getTitleClasses(type: AlertType): string {
  switch (type) {
    case 'success':
...
export function getMessageClasses(type: AlertType): string {
  switch (type) {
    case 'success':
