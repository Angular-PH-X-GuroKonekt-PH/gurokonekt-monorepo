...
export const FORM_CONFIGURATIONS = {
  ...
  MENTEE_REGISTER: {
    fields: {
      ...
      country: { validators: FORM_FIELD_VALIDATORS.COUNTRY, initialValue: 'PH' },
      timezone: { validators: FORM_FIELD_VALIDATORS.TIMEZONE, initialValue: 'Asia/Manila' },
  ...
  MENTOR_REGISTER: {
    fields: {
      ...
      timezone: { validators: FORM_FIELD_VALIDATORS.TIMEZONE, initialValue: 'Asia/Manila' },
      language: { validators: FORM_FIELD_VALIDATORS.LANGUAGE, initialValue: 'en' },
      areasOfExpertise: { validators: FORM_FIELD_VALIDATORS.EXPERTISE_AREAS, initialValue: [] },
      ...
      // File presence is validated via selectedFiles in the page; keep control unconstrained.
      files: { validators: [], initialValue: [] },
      acceptTerms: { validators: FORM_FIELD_VALIDATORS.ACCEPT_TERMS, initialValue: false },
    },
    groupValidators: [FORM_GROUP_VALIDATORS.PASSWORD_MATCH],
  },
