...
export class AuthController {
  ...
  @ApiResponse({ status: 429, description: 'Too many failed login attempts. Lockout escalates with the failure count (15 minutes, then 1 hour, then 24 hours); the response message states how long is left. Completing a password reset clears the lockout.' })
  async signIn(
